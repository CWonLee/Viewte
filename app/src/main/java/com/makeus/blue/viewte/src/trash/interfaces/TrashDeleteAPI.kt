...
import com.makeus.blue.viewte.src.trash.models.ResponseDeleteTrash
...
interface TrashDeleteAPI {
    @DELETE("/recyclebin")
    fun deleteTrash(): Call<ResponseDeleteTrash>

    companion object {

        fun create(): TrashDeleteAPI {
            ...
            return Retrofit.Builder()
                ...
                .build()
                .create(TrashDeleteAPI::class.java)
        }
    }
}